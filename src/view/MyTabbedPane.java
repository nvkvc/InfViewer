...
public class MyTabbedPane extends JTabbedPane{
	 ...
	 */
	public void addFileViewPanel(AbstractFile file) throws JSONException{
		FileView panel = new FileView(file);
		addTab(file.getName(), panel);
		setSelectedComponent(panel);
	}
	
	public void addDBViewPanel(AbstractFile file) throws JSONException{
		DBView panel = new DBView((DBFile) file);
		addTab(file.getName(), panel);
		setSelectedComponent(panel);
	}
