...
public class SkladisteTreeNode extends AbstractTreeNode{

	private Skladiste skladiste;
	private ArrayList<AbstractSChildTreeNode> deca;
	
	public SkladisteTreeNode(Skladiste skladiste){
		this.skladiste = skladiste;
		deca = new ArrayList();
		for(AbstractSChild dete: skladiste.getDeca()){
	...
	public SkladisteTreeNode(String name){
